...
const HowItWorksSection = () => {
  ...
  return (
    <section id="como-funciona" className="section-padding bg-accent/30">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="section-title">Como Funciona?</h2>
          <p className="text-lg text-text/80 max-w-2xl mx-auto">
            Criar peças incríveis com os moldes da Creativa é tão simples quanto 1, 2, 3!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div 
              key={index} 
              className="bg-white rounded-xl p-6 shadow-md flex flex-col items-center text-center hover:shadow-lg transition-shadow"
            >
              <div className="mb-4">
                {step.icon}
              </div>
